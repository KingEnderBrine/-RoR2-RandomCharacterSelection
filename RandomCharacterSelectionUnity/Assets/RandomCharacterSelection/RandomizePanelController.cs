...
namespace RandomCharacterSelection
{
    public class RandomizePanelController : MonoBehaviour
    {
        ...
        {
            orig(self);
            self.StartCoroutine(RandomizePanel(self));
        }
        ...
        private static IEnumerator RandomizePanel(CharacterSelectController self)
        {
            ...
            {
                var rightInputs = cscInputEvents.Where(el => el.actionName == "UIPageRight");
                cscRightInputEventOne = rightInputs.ElementAt(0);
                cscRightInputEventTwo = rightInputs.ElementAt(1);
            }
            else
            {
                cscRightInputEventOne = cscInputEvents.First(el => el.actionName == "UIPageRight");
            ...
            var randomizePanelRightInputEvent = randomizePanel.GetComponents<HGGamepadInputEvent>().First(input => input.actionName == "UIPageRight");

            var cscLeftInputEventOne = self.gameObject.AddComponent<DelayedInputHGGamepadInputEvent>();
            cscLeftInputEventOne.actionName = "UIPageLeft";
            ...
            var cscLeftInputEventTwo = self.gameObject.AddComponent<DelayedInputHGGamepadInputEvent>();
